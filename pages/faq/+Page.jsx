      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container max-w-3xl mx-auto px-4 sm:px-6 py-12">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Got questions about Satsu? Here are some quick answers. If something's missing, 
              <a href="/feedback" className="text-violet-400 hover:text-violet-300 inline-flex items-center gap-1 mx-1">
  ...
  const faqs = [
    {
      ...
      answer: "Yes. Satsu doesn't use cookies, doesn't track IPs, doesn't fingerprint users, and doesn't collect personal data. You don't need a cookie banner, and your visitors stay anonymous by design."
    },
    {
      question: "Do I need a cookie consent banner?",
      answer: "No. Satsu is 100% cookieless and does not collect any personally identifiable information (PII). That means no consent banners are required in the EU or anywhere else."
    },
    {
      question: "What data does Satsu track?",
      answer: "We only track anonymized pageviews, referrer URLs, device type, and location (country-level). No user IDs, no sessions, no creepy stuff."
    },
    {
      question: "Is it really free?",
      answer: "Yes – Satsu is free during development. Once we launch, the core features will stay free forever. Advanced features may become part of a paid plan, but pricing will always be dev-friendly."
    },
    {
      question: "How do I install it?",
      answer: "Just add a single script tag to your site. That's it. No account needed. You'll instantly start seeing traffic in your dashboard."
    },
    {
      question: "Can I use Satsu on multiple sites?",
      answer: "Yes. You can track as many projects as you want – especially while we're in open beta."
    },
    {
      question: "Is Satsu open source?",
      answer: "No. We're fully hosted and focused on delivering the best experience without needing you to self-host or maintain anything."
    },
    {
      ...
      answer: (
        <>
          ...
          <a href="/feedback" className="text-violet-400 hover:text-violet-300 mx-1">
            our feedback page
          </a> 
      ...
      <Accordion type="single" collapsible className="space-y-4">
        {faqs.map((faq, index) => (
          <motion.div key={index} variants={itemVariants}>
            <AccordionItem value={`item-${index}`} className="border-zinc-800 last:border-0">
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="text-zinc-300 mb-6 max-w-lg mx-auto">
          We're building Satsu with your feedback in mind. If you have questions that aren't answered here, or suggestions for how we can improve, let us know.
        </p>
