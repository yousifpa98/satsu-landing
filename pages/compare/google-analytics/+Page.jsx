      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Google Analytics is powerful, but it comes with serious baggage – from privacy concerns and cookie banners to bloated scripts and overwhelming dashboards. Satsu is a clean, focused alternative that gives developers exactly what they need: fast, ethical, real-time analytics – without the bloat or complexity.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="relative z-10 text-center max-w-2xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">Ready to upgrade your analytics?</h3>
              
              <p className="text-zinc-300 mb-8">
                Satsu is the Google Analytics alternative for developers who want to move fast, stay compliant, and respect their users. Skip the bloat. Drop in one script. Start tracking today – for free.
              </p>
  ...
  const reasons = [
    {
      ...
      satsu: "Collects zero personal data. No cookies, no IP tracking, no fingerprinting – and no need for annoying consent banners. It's privacy-first by design, not just as an option.",
      ga: "Collects personal data and requires user consent in most regions, especially under GDPR. This means cookie banners, data sharing, and a growing number of legal concerns."
    },
    {
      id: "lightweight",
      title: "Lightweight and Fast",
      satsu: "Loads in under 3 KB and has zero impact on performance. Your site stays fast, your users stay happy.",
      ga: "Adds 40–100 KB+ to your site, and often includes third-party calls and delays."
    },
    {
      id: "realtime",
      title: "Real-Time, Not Sampled",
      satsu: "Shows you what's happening on your site right now. Every visitor, every pageview – in real-time, with no sampling.",
    ...
    },
    {
      id: "setup",
      title: "Simpler Setup",
      satsu: "Just one script. Drop it into your site and start tracking – in under 30 seconds.",
      ga: "Requires a Google account, a property, possibly Google Tag Manager, and then hope you didn't mess up."
    },
    {
      id: "developers",
      title: "Built for Developers",
      satsu: "Built for developers. It gives you the numbers you actually care about – visitors, pageviews, referrers, devices – in one clean, dark-mode dashboard.",
      ga: "A tool for marketers, filled with dashboards, reports, segments, events, filters, views, and more."
    },
    {
      id: "ethical",
      title: "Ethical by Default",
      satsu: "There's no tracking of individuals, no data resale, and no hidden agendas. Just ethical analytics, built for devs like you.",
