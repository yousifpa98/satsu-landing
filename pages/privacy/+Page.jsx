        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6">
          <div className="space-y-16">
            ...
            <Section
              ...
              content={
                <p>You can delete your account at any time via your dashboard or by emailing us at <a href="mailto:hello@satsu.dev" className="text-violet-400 hover:text-violet-300">hello@satsu.dev</a>. All associated data (including your sites and traffic data) will be permanently deleted from our systems.</p>
              }
            />
            ...
            <Section
              ...
              content={
                <p>If you have any questions about how Satsu handles privacy, just email us directly: <a href="mailto:hello@satsu.dev" className="text-violet-400 hover:text-violet-300">hello@satsu.dev</a></p>
              }
            />
          </div>
        </div>
